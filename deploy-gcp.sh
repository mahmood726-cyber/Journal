...
#############################################################################
# Diamond OA Journal - Google Cloud Platform One-Click Deployment Script
#
# This script automatically deploys the journal system on Google Compute Engine
#
# Usage:
#   curl -sSL https://raw.githubusercontent.com/yourrepo/Journal/main/deploy-gcp.sh | bash
#
# Or:
#   wget -O - https://raw.githubusercontent.com/yourrepo/Journal/main/deploy-gcp.sh | bash
#
# Requirements:
#   - Fresh Ubuntu 22.04 LTS Compute Engine instance
#   - Minimum 4GB RAM (e2-medium)
...
╔══════════════════════════════════════════════════════════════╗
║                                                              ║
║        Diamond OA Journal - GCP Deployment                  ║
║        One-Click Installation for Google Cloud              ║
║                                                              ║
╚══════════════════════════════════════════════════════════════╝
EOF
echo -e "${NC}"
...
log_info "Detecting Google Cloud instance metadata..."
...
GCP_NAME=$(curl -s "http://metadata.google.internal/computeMetadata/v1/instance/name" -H "Metadata-Flavor: Google")
GCP_MACHINE_TYPE=$(curl -s "http://metadata.google.internal/computeMetadata/v1/instance/machine-type" -H "Metadata-Flavor: Google" | cut -d'/' -f4)
EXTERNAL_IP=$(curl -s "http://metadata.google.internal/computeMetadata/v1/instance/network-interfaces/0/access-configs/0/external-ip" -H "Metadata-Flavor: Google")

log_success "Google Cloud Instance Details:"
echo "  Project: $GCP_PROJECT"
echo "  Zone: $GCP_ZONE"
echo "  Instance: $GCP_NAME"
echo "  Machine Type: $GCP_MACHINE_TYPE"
echo "  External IP: $EXTERNAL_IP"
echo ""

# Warn about machine type
case $GCP_MACHINE_TYPE in
    f1-micro|g1-small|e2-micro|e2-small)
        log_warning "Your machine type ($GCP_MACHINE_TYPE) has less than 4GB RAM"
        log_warning "Minimum recommended: e2-medium (4GB RAM)"
        ;;
    e2-medium|e2-standard-2|n1-standard-2|n2-standard-2)
        log_success "Machine type is appropriate for journal operation"
        ;;
    *)
        log_success "Machine type looks good"
        ;;
esac
...
FIREWALL_HTTP=$(gcloud compute firewall-rules list --format="get(name)" --filter="allowed[].map().firewall_rule().list():80" 2>/dev/null | head -1 || echo "")
FIREWALL_HTTPS=$(gcloud compute firewall-rules list --format="get(name)" --filter="allowed[].map().firewall_rule().list():443" 2>/dev/null | head -1 || echo "")

if [ -z "$FIREWALL_HTTP" ]; then
    log_warning "HTTP (port 80) firewall rule not found"
    log_info "Create rule: gcloud compute firewall-rules create allow-http --allow tcp:80 --target-tags=http-server"
fi

if [ -z "$FIREWALL_HTTPS" ]; then
    log_warning "HTTPS (port 443) firewall rule not found"
    log_info "Create rule: gcloud compute firewall-rules create allow-https --allow tcp:443 --target-tags=https-server"
fi
...
echo "  - If NO: Press Enter to use IP address ($EXTERNAL_IP)"
echo ""
...
# File Storage (Can use Google Cloud Storage later)
...
GCP_ZONE=$GCP_ZONE
GCP_INSTANCE=$GCP_NAME
GCP_DEPLOYMENT=true

# Optional: Google Cloud Storage (Configure later)
# GCS_BUCKET=journal-uploads
# GCS_PROJECT=$GCP_PROJECT
...
# Configure Google Cloud Monitoring (optional)
...
systemctl restart google-cloud-ops-agent || log_warning "Could not start monitoring agent"
...
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "  Google Cloud Specific:"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "Instance: $GCP_NAME ($GCP_MACHINE_TYPE)"
echo "Project:  $GCP_PROJECT"
echo "Zone:     $GCP_ZONE"
echo ""
echo "💡 Tip: Create a snapshot for easy backups!"
echo "   gcloud compute disks snapshot $GCP_NAME --zone=$GCP_ZONE"
echo ""
echo "💡 Tip: View logs in Cloud Console:"
echo "   https://console.cloud.google.com/logs/query?project=$GCP_PROJECT"
echo ""
echo "💡 Tip: Set up Cloud Storage for uploads:"
echo "   gsutil mb gs://journal-uploads-$GCP_PROJECT"
echo "   Configure in .env: GCS_BUCKET=journal-uploads-$GCP_PROJECT"
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
